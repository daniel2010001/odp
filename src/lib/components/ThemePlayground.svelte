<script lang="ts">
	...
	import { X, Palette, RotateCcw } from "lucide-svelte";
	...
	const colorSlots: ColorSlot[] = [
		{ label: "Primario", varName: "--primary", description: "Azul institucional — links, títulos, foco" },
		{ label: "Secundario", varName: "--secondary", description: "Rojo — CTAs, acentos de acción" },
		{ label: "Acento (fondo)", varName: "--accent", description: "Fondo suave para badges y highlights" },
		...
		{ label: "Texto secundario", varName: "--muted-foreground", description: "Texto apagado / labels" },
